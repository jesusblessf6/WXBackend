...
var Tpl = '<div style="top: {top}; left: {left}; -webkit-animation: fade {t1} {t2}, drop {t1} {t2};">\
			<img src="other/.com/Weisite/Home?pid=234867&bid=276726&wechatid=fromUsername/{url}" style="-webkit-animation: counterclockwiseSpinAndFlip {t5};width:{width};max-width:{maxHeight}; max-height:{maxHeight};">\
			</div>';
