            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><input type="text" required class="px" name="wxname" value=""  tabindex="1" size="25">　<span class="red">请准确填写，保证和微信官网上的资料一样</span>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><input type="text" required name="weixin" value="" class="px" tabindex="1" size="25">　比如：laoyang </td>
                ...
                <tr>
                 ...
                 <tr >
                  ...
                  <td><input type="text" name="token" maxlength="30" value="<?php echo ($tokenvalue); ?>" class="px" tabindex="1" size="40">(填写你的公众号)例：laoyangweixin,请勿填写英文,或者其它特殊字符，不超过30字符!</td>
