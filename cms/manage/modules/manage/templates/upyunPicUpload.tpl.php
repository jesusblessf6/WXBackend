...
$options['return-url'] = 'C('site_url').'/cms/manage/admin.php?m=manage&c=background&a=upyunPicUpload'; /// 页面跳转型回调地址
//$options['notify-url'] = 'C('site_url').'/cms/manage/admin.php?m=manage&c=background&a=upyunPicUpload'; /// 服务端异步回调地址, 请注意该地址必须公网可以正常访问
