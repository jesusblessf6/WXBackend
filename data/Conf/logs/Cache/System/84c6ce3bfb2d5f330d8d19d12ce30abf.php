...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 ...
 <!-- <tr> 
  ...
  <tr> 
      ...
      <td><input type="text" name="rptk_bind_name" value="<?php echo C('rptk_bind_name');?>" class="ipt" size="20" /><span> 例:test</span>
    </tr>
  <tr>
...
<!--
	 <tr>
      <td  height="48" align="right"><strong>云端API ID：</strong></td>
      <td><input type="text" name="rptk_wx_temp_api_id" value="<?php echo C('rptk_wx_temp_api_id');?>" class="ipt" size="20" /><span> 例:h3ec2ic7pe6a287u</span>
    </tr> 
  <tr>
      <td  height="48" align="right"><strong>云端API KEY：</strong></td>
      <td><input type="text" name="rptk_wx_temp_api_key" value="<?php echo C('rptk_wx_temp_api_key');?>" class="ipt" size="40" /><span>例:fpf503289416ebf7o7f7f24w23fcfev9</span>
    </tr>
-->
