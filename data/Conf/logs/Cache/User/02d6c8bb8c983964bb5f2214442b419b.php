...
<td><input type="text" name="account" value="<?php echo ($pay_config["account"]); ?>" class="px" style="width:350px;"> <span class="red">*</span></td>
</tr>

<tr>
<th width="120">支付宝PID：</th>
<td><input type="text" name="pid" value="<?php echo ($pay_config["pid"]); ?>" class="px" style="width:350px;"> <span class="red">*</span></td>
</tr>
<tr>
<th>支付宝KEY：</th>
<td><input type="text" name="key" value="<?php echo ($pay_config["key"]); ?>" class="px" style="width:350px;"> <span class="red">*</span></td>
</tr>
<tr><th>&nbsp;</th>
<td>
