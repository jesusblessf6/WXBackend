...
class DatabaseAction extends BackAction{
 ...
 public function recovery(){
  ...
  public function delete(){
    $filename="./backup/database/".strtotime($_GET['time']).".sql";
	//dump($filename);
    unlink($filename);
