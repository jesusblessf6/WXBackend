...
'license'=>'<div class="license"><h1>系统安装协议</h1>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改老杨公共平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 微宝马信公共平台，还是部份栏目使用 老杨公共平台，在你使用了 老杨公共平台的网站主页上必须加上 老杨公共平台  官方淘宝网址(<a href="http://tpman1.taobao.com" target="_blank">tpman1.taobao.com</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 老杨公共平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：</b> 2013年12月23日</p>
                <p align=right>BY 老杨公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 老杨公共平台V'.SOFT_VERSION.' 安装程序',
...
$dirfile_items = array(
    ...
    'info' => array('type' => 'file', 'path' => './data/Conf/info.php'),
);
...
?>
			<div class="footer">
			    <p>Powered by 老杨公共平台© v1.0 2012-2013</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
...
function config_edit() {
	...
	$config_info='../data/Conf/info.php';
