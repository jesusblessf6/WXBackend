...
class Reply_infoAction extends UserAction{
	...
	public function _initialize() {
		...
		'Dining'=>array('type'=>'Dining','name'=>'订餐','keyword'=>'订餐','url'=>'/index.php?g=Wap&m=Dining&a=index&dining=1&token='.$this->token),
		'Repast'=>array('type'=>'Repast','name'=>'点餐','keyword'=>'点餐','url'=>'/index.php?g=Wap&m=Repast&a=index&dining=1&token='.$this->token),
