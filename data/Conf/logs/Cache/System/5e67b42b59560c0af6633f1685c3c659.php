 ...
 <form id="myform" action="<?php echo U('Site/qianmoban_up');?>" method="post">
    ...
    <tr> 
      ...
      <div class="select_style">
		...
		<option value="laoyang">默认风格</option>
		<option value="zuixin">最新风格</option>
        <option  value="zise">微盟风格</option>
        <option value="qianlan">浅蓝风格</option>
        <option value="baiyin">html5风格</option>
		<option value="weiwin">微赢风格</option>
        <option value="weixiang">微享风格</option>
		<option value="pigcms">小猪风格</option>
		<option value="new1">大气风格</option>
		<option value="xiangying">响应式风格</option>
      ...
      <img  border="0" src="<?php echo RES;?>/images/qianmoban/zuixin.png" id="beerIcon" />
