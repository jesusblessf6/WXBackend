...
class LinkAction extends UserAction{
	...
	public function keywordModules(){
		...
		array('module'=>'Shop','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Store&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Shop'],'canselected'=>1,'linkurl'=>'','keyword'=>'微商城','askeyword'=>1),
		...
		array('module'=>'Signin','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Signin&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Signin'],'sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'微签到','askeyword'=>1),
		...
		array('module'=>'Zuqiu','linkcode'=>'','name'=>$this->modules['Zuqiu'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Red_packet','linkcode'=>'','name'=>$this->modules['Red_packet'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Hforward','linkcode'=>'','name'=>$this->modules['Hforward'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Sharetalent','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Sharetalent&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Sharetalent'],'sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'分享达人','askeyword'=>1),		
		array('module'=>'Diaoyan','linkcode'=>'','name'=>$this->modules['Diaoyan'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Invites','linkcode'=>'','name'=>$this->modules['Invites'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Zhaopianwall','linkcode'=>'','name'=>$this->modules['Zhaopianwall'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Live','linkcode'=>'','name'=>$this->modules['Live'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Repast','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Repast&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Repast'],'sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'点餐','askeyword'=>1),		
		array('module'=>'Baoming','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Baoming&a=list&token='.$this->token.'&wecha_id={wechat_id}','name'=>'主题活动','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'主题活动','askeyword'=>1),
		);
	}
	public function modules(){
		...
		array('module' => 'Host', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Host&a=detail&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Host'], 'sub' => 1, 'canselected' => 0, 'linkurl' => '', 'keyword' => '', 'askeyword' => 1), 
		array('module' => 'Groupon', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Groupon&a=grouponIndex&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Groupon'], 'sub' => 0, 'canselected' => 1, 'linkurl' => '', 'keyword' => '团购', 'askeyword' => 1), 
		array('module' => 'Shop', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Store&a=cats&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Shop'], 'sub' => 0, 'canselected' => 1, 'linkurl' => '', 'keyword' => '商城', 'askeyword' => 1), 
		array('module' => 'Dining', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Dining&a=index&dining=1&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Dining'], 'sub' => 0, 'canselected' => 1, 'linkurl' => '', 'keyword' => '订餐', 'askeyword' => 1), 
		array('module' => 'Wedding', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Wedding&a=index&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Wedding'], 'sub' => 1, 'canselected' => 0, 'linkurl' => '', 'keyword' => '', 'askeyword' => 1), 
		array('module' => 'Vote', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Vote&a=index&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Vote'], 'sub' => 1, 'canselected' => 0, 'linkurl' => '', 'keyword' => '', 'askeyword' => 1), 
		...
		array('module' => 'Yuyue', 'linkcode' => '', 'name' => $this->modules['Yuyue'], 'sub' => 1, 'canselected' => 0, 'linkurl' => '', 'keyword' => '', 'askeyword' => 1), 
		array('module'=>'Vcard','linkcode'=>'','name'=>$this->modules['Vcard'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Zuqiu','linkcode'=>'','name'=>$this->modules['Zuqiu'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Red_packet','linkcode'=>'','name'=>$this->modules['Red_packet'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Hforward','linkcode'=>'','name'=>$this->modules['Hforward'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Sharetalent','linkcode'=>'','name'=>$this->modules['Sharetalent'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),		
		array('module'=>'Diaoyan','linkcode'=>'','name'=>$this->modules['Diaoyan'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Invites','linkcode'=>'','name'=>$this->modules['Invites'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Live','linkcode'=>'','name'=>$this->modules['Live'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Repast','linkcode'=>'','name'=>$this->modules['Repast'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Car','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Car&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Car'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		array('module'=>'Baoming','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Baoming&a=list&token='.$this->token.'&wecha_id={wechat_id}','name'=>'主题活动','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'报名活动','askeyword'=>1),
		);
	}
...

    {
        ...
        if ($list) {
            ...
            foreach ($list as $item) {
                ...
                array_push($items, array('id' => $item['id'], 'name' => $item['name'], 'linkcode' => (('{siteUrl}/index.php?g=Wap&m=Repast&a=select&token=' . $this->token) . '&wecha_id={wechat_id}&cid=') . $item['id'], 'linkurl' => '', 'keyword' => $item['keyword']));
    ...
    public function Zuqiu()
    {
		...
		if ($list){
			foreach ($list as $item){
				array_push($items,array('id'=>$item['id'],'name'=>$item['title'],'linkcode'=>'{siteUrl}/index.php?g=Wap&m=Zuqiu&a=index&token='.$this->token.'&wecha_id={wechat_id}&id='.$item['id'],'linkurl'=>'','keyword'=>$item['keyword']));
			}
		}
		//
		$this->assign('list',$items);
   ...
   public function Diaoyan()
	...
	public function Zhaopianwall()

    {
        $moduleName = 'Zhaopianwall';
...

    {
        ...
        if ($list) {
            ...
            foreach ($list as $item) {
                ...
                array_push($items, array('id' => $item['id'], 'name' => $item['title'], 'linkcode' => (('{siteUrl}/index.php?g=Wap&m=Red_packet&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&id=') . $item['id'], 'linkurl' => '', 'keyword' => $item['keyword']));
  ...
  public function Live()
	...
	public function Sharetalent()

    {

        $moduleName = 'Sharetalent';
        ...
        if ($list) {
            ...
            foreach ($list as $item) {
                ...
                array_push($items, array('id' => $item['id'], 'name' => $item['title'], 'linkcode' => (('{siteUrl}/index.php?g=Wap&m=Sharetalent&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&id=') . $item['id'], 'linkurl' => '', 'keyword' => $item['keyword']));
...

    {
        ...
        if ($list) {
            ...
            foreach ($list as $item) {
                ...
                array_push($items, array('id' => $item['id'], 'name' => $item['title'], 'linkcode' => (('{siteUrl}/index.php?g=Wap&m=Hforward&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&id=') . $item['id'], 'linkurl' => '', 'keyword' => $item['keyword']));
...

    {
        ...
        if ($list) {
            ...
            foreach ($list as $item) {
                ...
                array_push($items, array('id' => $item['id'], 'name' => $item['title'], 'linkcode' => (('{siteUrl}/index.php?g=Wap&m=Ktv&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&id=') . $item['id'], 'linkurl' => '', 'keyword' => $item['keyword']));
            } 
        ...
        if ($list) {
            foreach ($list as $item) {
                array_push($items, array(
                    'id' => $item['id'],
                    'name' => $item['name'],
                    'linkcode' => '{siteUrl}/index.php?g=Wap&m=Store&a=cats&token=' . $this->token . '&wecha_id={wechat_id}&cid=' . $item['id'],
                    'linkurl' => '',
                    'keyword' => '商城'
                ));
            }
        ...
        if ($list) {
            foreach ($list as $item) {
                array_push($items, array(
                    'id' => $item['id'],
                    'name' => $item['name'],
                    'linkcode' => '{siteUrl}/index.php?g=Wap&m=Store&a=products&token=' . $this->token . '&wecha_id={wechat_id}&catid=' . $item['id'],
                    'linkurl' => '',
                    'keyword' => '商城'
                ));
            }
...
//外链小工具
	...
	public function OutsideLink(){
		//处理小工具数组文件
			$f = include('./laoyang/Lib/ORG/Func.links.php');
		//取出分类总汇
			$i=0;
