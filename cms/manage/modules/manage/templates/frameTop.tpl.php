...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="height:84px;background:url(image/b.jpg) repeat-x;">
  <tr>
    <td style="padding:0 0 0 20px;width:200px;"><img src="image/logo-laoyang.png" border="0" /></td>
    <td>
...
?>
|<a href="<?php echo '../index.php?token='.$this->token;?>" target="_blank">访问网站</a>|<a href="<?php echo Laoyang_URL.'/index.php?g=User&m=Home&a=set&token='.$this->token;?>" target=_top style="color:#99C9EA">返回管理中心</a>
</div>
</div>
</td>
  </tr>
