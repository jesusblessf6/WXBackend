...
-webkit-appearance: none; /*for Webkit browsers*/
 ...
 <form id="myform" action="<?php echo U('Site/huiyuan_up');?>" method="post">

    <tr> 
      <td width="10%"  height="48"  align="right"><strong>选择会员模版：</strong></td>
      <td  align="left"> 
        ...
        function setBeerIcon() {
          ...
          beerIcon.src = "<?php echo RES;?>/images/huiyuan/"+rtl1.options[rtl1.selectedIndex].value+".png";
        }
        </script>
      ...
      <img  border="0" src="<?php echo RES;?>/images/huiyuan/zuixin.png" id="beerIcon" />
