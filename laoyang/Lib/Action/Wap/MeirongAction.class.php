<?php
class MeirongAction extends WapAction
{
    public $token;
    public $wecha_id;
    ...
    public function housetype()
    {
        ...
        $where       = array(
            'token' => $this->_get('token'),'thetype' => 'meirong'
        );
        ...
        $es_data     = $data1->where($where1)->find();
        $this->assign('es_data', $es_data);
        $this->display();
    }
    ...
    public function impress()
    {
        ...
        $impress   = $t_impress->where(array('is_show'=>1,'token' => $this->_get('token')))->order('sort desc')->select();
