		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
				<li class="open">
                    	...
                    	<li>
						<a href="javascript:openapp('<?php echo U('Alipay/index');?>','5Admin','升降级');">
								<i class="fa fa-angle-double-right"></i>
								<span class="menu-text">升降级</span>
							</a>
					</li>
                    	<li>
						<a href="javascript:openapp('<?php echo U('Index/editsms',array('token'=>$token));?>','6Admin','短信管理');">
								<i class="fa fa-angle-double-right"></i>
