...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="site_name" value="<?php echo ($f_siteName); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：宝微管家</span>
	  </td>
    </tr>
	 <tr> 
     ...
     <tr> 
      ...
      <td><input type="text" id="erwei" name="erwei" value="<?php echo C('erwei');?>" class="ipt" size="45" />  <span>&nbsp;&nbsp;<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('erwei',190,60,'<?php echo ($token); ?>')" style="color:red">上传</a> <a href="###" onclick="viewImg('erwei')">预览</a>&nbsp;&nbsp;</span>
    </tr>
	 <tr> 
      <td  height="48" align="right"><strong>网站地址：</strong></td>
      <td><input type="text" name="site_url" value="<?php echo ($f_siteUrl); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.laoyang.com</span>
    </tr>
	<tr> 
      <td  height="48" align="right"><strong>Banner1：</strong></td>
      <td><input type="text" class="ipt" id="banner1" name="banner1" value="<?php echo C('banner1');?>" size="45" /><span>&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('banner1',190,60,'<?php echo ($token); ?>')" style="color:red">上传</a> <a href="###" onclick="viewImg('banner1')">预览</a>&nbsp;&nbsp;</span>

        Banner2:

        <input type="text" class="ipt" id="banner2" name="banner2" value="<?php echo C('banner2');?>" size="45" /><span>&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('banner2',190,60,'<?php echo ($token); ?>')" style="color:red">上传</a> <a href="###" onclick="viewImg('banner2')">预览</a>&nbsp;&nbsp;</span>
		</td>
	</tr>  

	<tr> 
      <td  height="48" align="right"><strong>Banner3：</strong></td>
      <td><input type="text" class="ipt" id="banner3" name="banner3" value="<?php echo C('banner3');?>" size="45" /><span>&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('banner3',190,60,'<?php echo ($token); ?>')" style="color:red">上传</a> <a href="###" onclick="viewImg('banner3')">预览</a>&nbsp;&nbsp;</span>

		Banner4:

		<input type="text" class="ipt" id="banner4" name="banner4" value="<?php echo C('banner4');?>" size="45" /><span>&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('banner4',190,60,'<?php echo ($token); ?>')" style="color:red">上传</a> <a href="###" onclick="viewImg('banner4')">预览</a>&nbsp;&nbsp;</span>
		</td>
	</tr>  

	<tr> 
      <td  height="48" align="right"><strong>Banner5：</strong></td>
      <td><input type="text" class="ipt" id="banner5" name="banner5" value="<?php echo C('banner5');?>" size="45" /><span>&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('banner5',190,60,'<?php echo ($token); ?>')" style="color:red">上传</a> <a href="###" onclick="viewImg('banner5')">预览</a>&nbsp;&nbsp;</span>

        Banner6:

        <input type="text" class="ipt" id="banner6" name="banner6" value="<?php echo C('banner6');?>" size="45" /><span>&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('banner6',190,60,'<?php echo ($token); ?>')" style="color:red">上传</a> <a href="###" onclick="viewImg('banner6')">预览</a>&nbsp;&nbsp;</span>
		</td>
	</tr>  
	<tr> 
	<tr> 
...
<!--     <tr> 
    ...
    <!-- <tr> 
      ...
      <td><input type="text" name="router_key" value="<?php echo C('router_key');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;第一次买路由后请联系laoyang官方</span>
    </tr> -->
	<tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:server@laoyang.cn</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="copyright" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:laoyang版权所有</span>
    </tr>
