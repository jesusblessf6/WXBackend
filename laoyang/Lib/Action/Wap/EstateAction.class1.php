...
class EstateAction extends WapAction{
    ...
    public function index(){
        ...
        $data = M("Estate");
        $this->token=$this->_get('token');
        $where = array('token'=>$this->token,'thetype'=>'estate');
    ...
    public function housetype(){
        ...
        $where = array('token'=>$this->_get('token'),'thetype' => 'estate');
    ...
    public function album(){
        ...
        $album = $t_album->where(array('token'=>$this->_get('token'),'thetype' => 'estate'))->field('id,poid')->select();
        $list_photo = array();
